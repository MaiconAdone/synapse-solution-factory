export const ADONEX_FAST_LOCAL_MODEL = "qwen2.5-coder:3b";
export const ADONEX_REASONING_LOCAL_MODEL = "deepseek-coder-v2:lite";
export const ADONEX_GENERAL_LOCAL_MODEL = "qwen3:8b";
export const ADONEX_CODE_STRONG_LOCAL_MODEL = "qwen2.5-coder:14b";
export const ADONEX_PLANNING_STRONG_LOCAL_MODEL = "qwen3:14b";
export const ADONEX_REASONING_STRONG_LOCAL_MODEL = "deepseek-r1:14b";
export const ADONEX_CODE_CRITICAL_LOCAL_MODEL = "qwen2.5-coder:32b";
