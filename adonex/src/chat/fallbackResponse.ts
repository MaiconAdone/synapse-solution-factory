...
function createSynapseExplanation(
  ...
  return [
    ...
    "- Frontend React/Next.js: interface web independente do VS Code para operar projetos, agentes, memoria, MLflow e workflows.",
    "- Postgres e storage: base para estado, projetos, usuarios, registros e integracoes futuras.",
    "- MLflow/Jupyter: suporte a experimentos, linhagem, avaliacao, notebooks e ciclo ML.",
    "",
