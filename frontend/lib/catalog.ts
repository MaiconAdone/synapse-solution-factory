export const agents = [
  ["orchestration-manager", "Roteia trabalho e governa o swarm"],
  ["product-strategy", "Objetivo de negocio, metricas e aceite"],
  ["data-engineering", "Pipelines, validacao e linhagem"],
  ["data-science", "Analise, estatistica, vieses e features"],
  ["machine-learning", "Desenho de modelos, avaliacoes e monitoramento"],
  ["llm-engineering", "Prompts, ferramentas, guardrails e avaliacoes"],
  ...
  ["testing-qa", "Quality gates e estrategia de regressao"],
  ["documentation", "Arquitetura e documentacao operacional"],
];
